        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <form  action="registre" method="post" >
                ...
                <div class="wrap-input100 validate-input" data-validate="Please enter your phone">
                    ...
                    <span style="font-size:20px; margin-top:10px; margin-left:14px" class="focus-input100 ">☏</span>
                </div>
...
<br>
                <div class="wrap-input100 validate-input m-b-23" data-validate = "Adressr is reauired">
                    ...
                    <input class="input100" type="text" name="adress" placeholder="Type your adress">
                    <span class="focus-input100" data-symbol="&#x2690;"></span>
                ...
                <div class="flex-col-c p-t-70">
						<span class="txt1 p-b-17" style="color: #c92843;      font-size: 16px;">
                                <%=res%>
                        </span>
                </div>
                <%
